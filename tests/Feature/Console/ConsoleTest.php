...
class ConsoleTest extends TestCase
{
    ...
    {
        $this->artisan('jory:generate', ['--model' => 'JosKolenberg\LaravelJory\Tests\Feature\Console\Models\Band'])
    ...
    public function it_can_run_a_generate_for_command_for_a_model_with_name_option()
    {
        $this->artisan('jory:generate', [
            '--model' => 'JosKolenberg\LaravelJory\Tests\Feature\Console\Models\Band',
