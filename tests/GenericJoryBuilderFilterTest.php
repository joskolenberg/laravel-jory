...
class GenericJoryBuilderFilterTest extends TestCase
{
    ...
    /** @test */
    function it_can_filter_by_the_default_laravel_operators()
    {
        // =, >, <, <>, !=, like, not like, <=, >=
    ...
    /** @test */
    function it_can_filter_on_null_values()
    {
        $actual = BandWithTrait::jory()->applyArray([
            "filter" => [
                "f" => "year_end",
    ...
    /** @test */
    function it_can_filter_on_non_null_values()
    {
        $actual = BandWithTrait::jory()->applyArray([
            "filter" => [
                "f" => "year_end",
    ...
    /** @test */
    function it_can_apply_an_IN_filter()
    {
        $actual = BandWithTrait::jory()->applyArray([
            "filter" => [
                "f" => "id",
    ...
    /** @test */
    function it_can_apply_a_NOT_IN_filter()
    {
        $actual = BandWithTrait::jory()->applyArray([
            "filter" => [
                "f" => "id",
    ...
    /** @test */
    function it_defaults_to_an_EQUALS_check_if_no_operator_is_given()
    {
        $actual = BandWithTrait::jory()->applyArray([
            "filter" => [
                "f" => "name",
